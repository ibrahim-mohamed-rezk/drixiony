...
function CarListingLeftSidebar() {
  ...
  useEffect(() => {
    const feachData = async () => {
      try {
        const response = await getData("cars/filters", activeFilter, {
  ...
  return (
    <MainLayout>
      <div
        className="product-page pt-100 mb-100"
        dir="rtl"
              ...
              <div className="row mb-40">
                <div className="col-lg-12">
                  <div className="show-item-and-filte">
                    <p>
                      عرض <strong>{pagination.total}</strong> سيارة متوفرة في
                      المخزون
                    </p>
                        ...
                        >
                          <div className="product-card">
                            ...
                            <div className="product-content">
                              <h5>
                                <Link href="/car-deatils">{car.name}</Link>
                              </h5>
                              <div className="price-location">
                                <div className="price">
                                  <strong>{car.price} جنيه</strong>
                                </div>
